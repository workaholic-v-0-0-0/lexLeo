...
static inline fake_file_t *osal_file_to_fake_file(OSAL_FILE *file) { return (fake_file_t *)file; }
static inline OSAL_FILE *fake_file_to_osal_file(fake_file_t *fake) { return (OSAL_FILE *)fake; }
