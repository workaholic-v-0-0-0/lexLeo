 ...
 * to managing a hash table. The hash table stores key-value pairs using
 ...
 *
 * \param hashtable The hash table in which to search for the key.
 ...
 */
void * get_value(hashtable, hash_location);
 ...
 *
 * \param hashtable The hash table in which to store the entry.
 ...
 * the key and value.
 *
 * \param hep A pointer to the `hash_entry` to be cleaned up.
 */
void cleanup_hash_entry(hash_entry *);
 ...
 *
 * \param hashtable The hash table to be cleaned up.
 */
void cleanup_hashtable(hashtable);
