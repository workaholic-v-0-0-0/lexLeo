// src/core/symtab/include/symtab.h
...
int symtab_intern_symbol(symtab *st, const char *name); // the caller is responsible for st ; do nothing if symbol already interned
