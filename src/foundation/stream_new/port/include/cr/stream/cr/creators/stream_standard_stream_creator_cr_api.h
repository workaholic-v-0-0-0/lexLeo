...
/**
 * @file stream_standard_stream_creator_cr_api.h
 * @ingroup stream_cr_api
 * @brief Composition Root API for standard stream creators.
 *
 * @details
 * This header exposes CR-facing services used to create and destroy
 * `stream_standard_stream_creator_t` objects.
 */

#ifndef LEXLEO_STREAM_STANDARD_STREAM_CREATOR_CR_API_H
#define LEXLEO_STREAM_STANDARD_STREAM_CREATOR_CR_API_H

#include "stream/cr/stream_cr_types.h"
#include "stream/owners/creators/stream_standard_stream_creator.h"
...
/**
 * @brief Create a standard stream creator.
 *
 ...
 *
 * See contract:
 * - @ref specifications_stream_create_standard_stream_creator
 */
...
/**
 * @brief Destroy a standard stream creator.
 *
 * @param[in,out] creator Address of the creator handle to destroy.
 *
 * See contract:
 * - @ref specifications_stream_destroy_standard_stream_creator
 */
...
#endif /* LEXLEO_STREAM_STANDARD_STREAM_CREATOR_CR_API_H */
