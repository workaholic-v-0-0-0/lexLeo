...
/**
 * @file stream_dynamic_buffer_creator_cr.c
 * @ingroup stream_internal_group
 * @brief Dynamic buffer stream creator lifetime implementation.
 *
 * @details
...
stream_factory_status_t stream_create_dynamic_buffer_creator(
	...
	stream_dynamic_buffer_creator_t *tmp = mem->calloc(1, sizeof(*tmp));
	if (!tmp) {
