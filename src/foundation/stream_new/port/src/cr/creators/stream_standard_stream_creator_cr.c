...
/**
 * @file stream_standard_stream_creator_cr.c
 * @ingroup stream_internal_group
 * @brief Standard stream creator lifetime implementation.
 *
 * @details
...
stream_factory_status_t stream_create_standard_stream_creator(
	...
	stream_standard_stream_creator_t *tmp = mem->calloc(1, sizeof(*tmp));
	if (!tmp) {
