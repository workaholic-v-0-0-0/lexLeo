 ...
 * construct `fs_stream` backends and register the adapter from a Composition
 * Root.
 */
 ...
 * @ingroup fs_stream_cr_api
 * @brief Configuration values used to complete the initialization of an
 * `fs_stream` handle.
 *
 * @details
 * Groups the configuration values provided by the Composition Root when
 * completing the initialization of an `fs_stream` backend.
 */
 ...
 * @ingroup fs_stream_cr_api
 * @brief External borrowed dependencies required to construct the `fs_stream`
 * handle.
 */
