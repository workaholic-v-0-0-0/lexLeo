...
typedef enum {
	 ...
	 */
	OSAL_FILE_READ_SCENARIO_ZERO_LENGTH,
...
static const test_osal_file_read_case_t CASE_OSAL_FILE_READ_ZERO_LENGTH = {
	.name = "osal_file_read_zero_length",
	.scenario = OSAL_FILE_READ_SCENARIO_ZERO_LENGTH,
...
X(CASE_OSAL_FILE_READ_ZERO_LENGTH) \
...
typedef struct {
	...
	uint8_t first_write_content[16];
	size_t first_write_content_len;
	size_t first_size;
	size_t first_nmemb;
	bool do_second_write;
	size_t second_write_content_len;
	size_t second_size;
	size_t second_nmemb;
	...
	size_t first_expected_ret;
	osal_file_status_t first_expected_st;
	uint8_t first_expected_file_content[16];
	size_t second_expected_ret;
	osal_file_status_t second_expected_st;
	uint8_t second_expected_file_content[16];
