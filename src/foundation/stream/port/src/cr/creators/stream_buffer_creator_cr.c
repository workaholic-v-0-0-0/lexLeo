...
/**
 * @file stream_buffer_creator_cr.c
 * @ingroup stream_internal_group
 * @brief Buffer stream creator lifetime implementation.
 *
 * @details
...
stream_status_t stream_create_buffer_creator(
	...
	stream_buffer_creator_t *tmp = mem->calloc(1, sizeof(*tmp));
	if (!tmp) {
...
void stream_destroy_buffer_creator(stream_buffer_creator_t **creator
	...
	stream_buffer_creator_t *tmp = *creator;
	*creator = NULL;
