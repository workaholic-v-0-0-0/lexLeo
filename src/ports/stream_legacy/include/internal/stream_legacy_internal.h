// src/ports/stream/include/internal/stream_internal.h
...
#include "internal/stream_legacy_memory_allocator.h"

#include <stddef.h>

typedef struct stream_legacy_vtable {
	size_t (*read)(void *ctx, void* buf, size_t n);
	size_t (*write)(void *ctx, const void* buf, size_t n);
	int (*flush)(void *ctx);
	int (*close)(void *ctx);
} stream_legacy_vtable;
