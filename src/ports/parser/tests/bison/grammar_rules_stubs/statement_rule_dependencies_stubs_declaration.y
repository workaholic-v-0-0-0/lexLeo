// src/ports/parser/tests/bison/grammar_rules_stubs/statement_rule_dependencies_stubs_declaration.y

// the following stubs are implemented in test_statement_parser.c
