// src/ports/parser/tests/test_number_atom_parser.c
...
static void number_atom_parse_calls_create_int_node_and_returns_its_returned_value_when_create_int_node_succeeds(
    void **state) {
    expect_value(mock_create_int_node, i, 5);
