# src/ports/parser/tests/cmake/build_unit_test.cmake
...
function(build_unit_test NAME)
    ...
    target_include_directories(
        ...
        PRIVATE
        "${CMOCKA_INCLUDE_DIR}"
        "${CMAKE_BINARY_DIR}/src/ports/lexer_legacy/include"
        ...
        "${CMAKE_BINARY_DIR}/src/ports/parser/tests/include"
    )
    add_dependencies("test_${NAME}_parser" move_generated_lexer_legacy_header)
    target_link_libraries("test_${NAME}_parser" PRIVATE "${NAME}_parser" ${CMOCKA_LIBRARY} lexer_legacy data_structures)
