@page specifications_stream_destroy_dynamic_buffer_creator stream_destroy_dynamic_buffer_creator() specifications
...
Destroy a dynamic buffer stream creator.
...
- `stream_destroy_dynamic_buffer_creator()` is the matching destructor for
  handles created by `stream_create_dynamic_buffer_creator()`.
