@page specifications_stream_destroy_file_creator stream_destroy_file_creator() specifications

# Signature

~~~c
void stream_destroy_file_creator(
    stream_file_creator_t **creator);
~~~

# Purpose

Destroy a file stream creator.
...
- The creator must have been created by `stream_create_file_creator()`.
