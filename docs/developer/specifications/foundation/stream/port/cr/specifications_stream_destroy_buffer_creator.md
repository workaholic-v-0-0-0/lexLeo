@page specifications_stream_destroy_buffer_creator stream_destroy_buffer_creator() specifications

# Signature

~~~c
void stream_destroy_buffer_creator(
    stream_buffer_creator_t **creator);
~~~

# Purpose

Destroy a buffer stream creator.
...
- The creator must have been created by `stream_create_buffer_creator()`.
